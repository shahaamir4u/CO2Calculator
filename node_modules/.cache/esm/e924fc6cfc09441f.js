let arg,validator;_fc0‍.x([["cli",()=>cli]]);_fc0‍.w("arg",[["default",["arg"],function(v){arg=v}]]);_fc0‍.w("validator",[["default",["validator"],function(v){validator=v}]]);
...
function parseArgumentsIntoOptions(rawArgs) {
    ...
    _fc0‍.g.console.log('myArgs: ', args);
    ...
    _fc0‍.g.console.log(process.env.ORS_TOKEN);
    ...
    _fc0‍.g.console.log('Cord1', startCoordinates);
    _fc0‍.g.console.log('Cord2', endCoordinates);
    if (startCoordinates != 'Address not found' && endCoordinates != 'Address not found') {
        ...
        if (distanceKms == 'Address not found')
            ...
            _fc0‍.g.console.log("Your trip caused", (distanceKms * co2Factor / 1000).toFixed(2), "kg of CO2-equivalent.");
...
async function getDistance(startCity, endCity) {
    return new Promise(function (resolve, reject) {
        ...
        request({
            ...
            var data = JSON.parse(body);
            var dist;
            _fc0‍.g.console.log(response.statusCode)
            if (response.statusCode >= 200 && response.statusCode < 400) {
                dist = data.features[0].properties.summary.distance;
                return resolve(dist);

            } else {
                _fc0‍.g.console.log(data.error.message);
                return resolve('Address not found');
            }
        });
